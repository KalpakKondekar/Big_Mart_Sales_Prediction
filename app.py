...
scaler=pickle.load(open(r"C:\Users\Dell\Desktop\End To End\Big Mart Sales Prediction\model\standaredScaler.pkl", "rb"))
model = pickle.load(open(r"C:\Users\Dell\Desktop\End To End\Big Mart Sales Prediction\model\modelPrediction.pkl", "rb"))
